...
export function LogoMark({ size = 34, className = '' }: { size?: number; className?: string }) {
  return (
    <svg
      ...
      className={className} role="img" aria-label="SOLFV"
    >
      <rect width="48" height="48" rx="11" className="logo-tile" />
      {/* The asserted figure. */}
      <rect x="12" y="15" width="24" height="4.5" rx="2.25" className="logo-bar" />
      {/* The verification. */}
      <path
